...
public class ProfileInfo {
    ...
    public String getIdToken() throws UnsupportedEncodingException {
        ...
        return new String(Base64.encode(claims.getBytes(AuthenticationConstants.ENCODING_UTF8),
