...
public class AuthenticationActivityInstrumentationTests extends
    ...
    private void loadConfigFromResource(String name) {
        Resources res = getInstrumentation().getContext().getResources();
        String pa = getInstrumentation().getContext().getPackageName();
        try {
            ...
            String val = p.getProperty("AAD-authority");
    ...
    // acquireTokenAfterReset(TestTenant.ADFS30FEDERATED, "",
    ...
    // acquireTokenAfterReset(TestTenant.ADFS20FEDERATED, "",
    // PromptBehavior.Auto, null, false,
    ...
    // acquireTokenAfterReset(TestTenant.ADFS30, "", PromptBehavior.Auto, null,
    // false, false, null);
    // }
    //
    // @MediumTest
    ...
    // Log.v(TAG, "testAcquireToken_Prompt starts for authority:" +
    // tenant.getAuthority());
    // final TextView textViewStatus =
    // (TextView)activity.findViewById(R.id.textViewStatus);
    ...
    // // Get token first
    // TestTenant tenant = TestTenant.MANAGED;
    // Log.v(TAG, "testAcquireTokenPromptAlways starts for authority:" +
    // tenant.getAuthority());
    // acquireTokenAfterReset(tenant, "", PromptBehavior.Auto, null, false,
    // false, null);
    //
    ...
    // setAuthenticationRequest(tenant, "", PromptBehavior.Auto, "prompt=login",
    // false);
    // clickGetToken();
    //
    // Log.v(TAG,
    // "prompt=login param will be posted to authorization endpoint");
    // AuthenticationActivity startedActivity = (AuthenticationActivity)monitor
    // .waitForActivityWithTimeout(ACTIVITY_WAIT_TIMEOUT);
    // assertNotNull(startedActivity);
    // startedActivity.finish();
    ...
    // acquireTokenAfterReset(TestTenant.MANAGED, "", PromptBehavior.Auto, null,
    // false, false,
    // null);
    //
    // UUID correlationId = UUID.randomUUID();
    // activity.setRequestCorrelationId(correlationId);
    // assertNotNull("Has token before checking correlationid",
    // activity.getResult());
    // assertNotNull("Has token before checking correlationid",
    // activity.getResult()
    // .getAccessToken());
    ...
    // @Override
    // public boolean hasCondition() throws IllegalArgumentException,
    ...
    // assertEquals("Result status is failed",
    // AuthenticationResult.AuthenticationStatus.Failed,
    // result.getStatus());
    // assertEquals("CorrelationId in response same as in request header",
    // correlationId,
    ...
    // // Not validating
    // Log.v(TAG,
    // "testing acquireTokenAfterReset for managed without validation");
    // acquireTokenAfterReset(TestTenant.MANAGED, "", PromptBehavior.Auto, null,
    // false, false,
    // null);
    //
    ...
    // }
    //
    // private void verifyRefreshRequest() throws IllegalArgumentException,
    ...
    // Log.v(TAG, "Wait for the page to set the result. Initial status:" +
    // startText);
    //
    ...
    // */
    // private void verifyToken() throws IllegalArgumentException,
    // InterruptedException,
    // NoSuchFieldException, IllegalAccessException {
    // final TextView textViewStatus =
    // (TextView)activity.findViewById(R.id.textViewStatus);
    ...
    // * @throws IllegalAccessException
    // */
    // private void acquireTokenByRefreshToken() throws
    ...
    // }
    //
    // private void setAuthenticationRequest(final TestTenant tenant, final
    // String loginhint,
    // final PromptBehavior prompt, String extraQueryParam, final boolean
    // validate) {
    // // ACtivity runs at main thread. Test runs on different thread
    // Log.v(TAG, "acquireTokenAfterReset starts for authority:" +
    // tenant.getAuthority());
    //
    // // press clear all button to clear tokens and cookies
    // final EditText mAuthority, mResource, mClientId, mUserid, mPrompt,
    // mRedirect;
    ...
    // (Button)activity.findViewById(R.id.buttonReset));
    // }
    //
    // private void clickGetToken() {
    // TouchUtils.clickView(this,
    // (Button)activity.findViewById(R.id.buttonGetToken));
    // }
    //
    // private void clickExpire() {
    // TouchUtils.clickView(this,
    // (Button)activity.findViewById(R.id.buttonExpired));
    // }
    //
    // private void clickVerify() {
    // TouchUtils.clickView(this,
    // (Button)activity.findViewById(R.id.buttonVerify));
    // }
    //
    // private void clickRemoveCookies() {
    // TouchUtils.clickView(this,
    // (Button)activity.findViewById(R.id.buttonRemoveCookies));
    // }
    //
    // private void clickRefresh() {
    // TouchUtils.clickView(this,
    // (Button)activity.findViewById(R.id.buttonRefresh));
    // }
    //
    // /**
    ...
    // assertTrue("Token in Authentication result is not null",
    ...
    // * @throws IllegalAccessException
    // */
    // private void handleCredentials(final ActivityMonitor monitor, String
    ...
    // assertTrue("Activity has login page",
    // hasLoginPage(getLoginPage(startedActivity)));
    // enterCredentials(federated, federatedPageUrl, startedActivity, username,
    // password);
    //
    // // wait for the page to set result
    // Log.v(TAG, "Wait for the page to set the result");
    ...
    // * @throws Exception
    // */
    // private void acquireTokenAfterReset(TestTenant tenant, String loginhint,
    // PromptBehavior prompt,
    // String extraQueryParam, boolean validate, boolean federated, String
    // federatedPageUrl)
    // throws Exception {
    // Log.v(TAG, "acquireTokenAfterReset starts for authority:" +
    // tenant.getAuthority());
    ...
    // final ActivityMonitor monitor = getInstrumentation().addMonitor(
    // AuthenticationActivity.class.getName(), null, false);
    // setAuthenticationRequest(tenant, loginhint, prompt, extraQueryParam,
    // validate);
    //
    // // press clear all button to clear tokens and cookies
    // clickResetTokens();
    // clickGetToken();
    // handleCredentials(monitor, tenant.getUserName(), tenant.getPassword(),
    // federated,
    // federatedPageUrl);
    //
    // String tokenMsg = (String)textViewStatus.getText();
    ...
    // }
    //
    // private void enterCredentials(boolean waitForRedirect, String
    // redirectUrl,
    ...
    // sleepUntilVisibleWebElements(startedActivity);
    // WebView webview =
    // (WebView)startedActivity.findViewById(com.microsoft.adal.R.id.webView1);
    // assertNotNull("Webview is not null", webview);
    // webview.requestFocus();
    //
    // String page = getLoginPage(startedActivity);
    // assertFalse("Page does not have login page", page == null ||
    // page.isEmpty());
    //
    ...
    // }
    //
    // private void clickWebElement(ArrayList<WebElement> elements, String[]
    // ids) {
    //
    ...
    // }
    //
    // private void enterTextIntoWebElement(ArrayList<WebElement> elements,
    // String[] ids, String text) {
    ...
    // }
    //
    // private void sleepUntilFederatedPageDisplays(final String
    // federatedPageUrl)
    ...
    // ADALError errorCode) {
    //
    // Log.v(TAG, "sleepUntilFederatedPageDisplays Message playback:" +
    // message);
    // if (message.toLowerCase(Locale.US).contains("page finished:" +
    // federatedPageUrl)) {
    // Log.v(TAG, "sleepUntilFederatedPageDisplays Page is loaded:" +
    // federatedPageUrl);
    // signal.countDown();
    ...
    // }
    //
    // private void sleepUntilLoginDisplays(final AuthenticationActivity
    // startedActivity)
    // throws InterruptedException, IllegalArgumentException,
    // NoSuchFieldException,
    // IllegalAccessException {
    ...
    // }
    //
    // private void sleepUntilVisibleWebElements(final AuthenticationActivity
    // startedActivity)
    // throws InterruptedException, IllegalArgumentException,
    // NoSuchFieldException,
    // IllegalAccessException {
    ...
    // * @throws IllegalAccessException
    // */
    // private void waitUntil(int timeOut, ResponseVerifier item) throws
    // InterruptedException,
    // IllegalArgumentException, NoSuchFieldException, IllegalAccessException {
    // int waitcount = 0;
    ...
    // boolean hasCondition() throws IllegalArgumentException,
    // NoSuchFieldException,
    // IllegalAccessException;
    // }
    //
    ...
    // IllegalAccessException {
    // Object scriptInterface = ReflectionUtils.getFieldValue(startedActivity,
    // "mScriptInterface");
    //
