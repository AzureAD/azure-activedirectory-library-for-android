...
public class TestIdToken {
    ...
    static final String sTestIdTokenClaims = "{\"aud\":\"c3c7f5e5-7153-44d4-90e6-329686d48d76\",\"iss\":\"https://sts.windows.net/6fd1f5cd-a94c-4335-889b-6c598e6d8048/\",\"iat\":1387224169,\"nbf\":1387224170,\"exp\":1387227769,\"pwd_exp\":1387227772,\"pwd_url\":\"pwdUrl\",\"ver\":\"1.0\",\"tid\":\"%s\",\"oid\":\"%s\",\"upn\":\"%s\",\"unique_name\":\"%s\",\"sub\":\"%s\",\"family_name\":\"%s\",\"given_name\":\"%s\",\"altsecid\":\"%s\",\"idp\":\"%s\",\"email\":\"%s\"}";

    static final String sTestIdTokenHeader = "{\"typ\":\"JWT\",\"alg\":\"none\"}";
    ...
    public String getTestIdToken() throws UnsupportedEncodingException {
        String claims = String.format(sTestIdTokenClaims, tid, oid, upn, unique_name, sub, family_name,
                given_name, altsecid, idp, email);
        return String.format(
                "%s.%s.",
                new String(Base64.encode(sTestIdTokenHeader.getBytes(AuthenticationConstants.ENCODING_UTF8),
