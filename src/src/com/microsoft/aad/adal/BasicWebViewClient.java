...
abstract class BasicWebViewClient extends WebViewClient {
	...
	public BasicWebViewClient(String redirect, int requestCode,
	...
	public void onReceivedError(WebView view, int errorCode,
		...
		resultIntent
				.putExtra(
						...
						mRequest);
		sendResponse(AuthenticationConstants.UIResponse.BROWSER_CODE_ERROR,
				resultIntent);
	}
	...
	public void onReceivedSslError(WebView view, SslErrorHandler handler,
		...
		Intent resultIntent = new Intent();
		resultIntent.putExtra(
				AuthenticationConstants.Browser.RESPONSE_ERROR_CODE, "Code:"
